...
const ViewClass = () => {
    ...
    const _handleDelete = (e, id) => {
        ...
        if (window.confirm('Are you sure you want to delete?')) {
            (async () => {
                try {
                    const { data, status } = await instance.delete(`/classes/${id}`);
                    if (status === 200) {
            ...
            <div className="container pd-x-0 pd-lg-x-10 pd-xl-x-0">
                <div className="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
                    <div>
                        ...
                        <h4 className="mg-b-0 tx-spacing--1">Class Listing</h4>
                    </div>
                    <div className="d-md-block d-none">
                        <Link className='btn btn-sm pd-x-15 btn-primary btn-uppercase mg-l-5' to="/addClass">
                            <svg
